...
<Image
  src="blog/fbo_3.png"
  alt="Diagram illustrating how the Frame Buffer Objects allows to store and update particles position data in a vertex shader and then be read as a texture."
  width={700}
  height={443}
/>
