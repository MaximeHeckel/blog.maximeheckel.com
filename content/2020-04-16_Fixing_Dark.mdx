...
categories: []
keywords: ['react', 'dark mode', 'server rendered', 'gatsby', 'css custom properties', 'theme']
...
![Gif showcasing the dark mode flash issue on this blog.](img/dark-mode-flash.gif)
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">The core of the issue: I was rendering a &lt;div/&gt; when loading the website and reading the localStorage to set the proper theme (since it&#39;s async). This stopped gatsby from going further during the SSR build step and hence not generating the pages (with meta tags) of my blog</p>&mdash; Maxime 🇫🇷 (@MaximeHeckel) <a href="https://twitter.com/MaximeHeckel/status/1163877803583868928?ref_src=twsrc%5Etfw">August 20, 2019</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
Note 2: I'll try to take some time to investigate and update this post with a solution for NextJS
