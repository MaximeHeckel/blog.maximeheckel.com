...
Because of this issue, the app ended up in a half-broken state on iOS 14.2, and I had so much refactoring to do that **I ended up restarting the development of Sunshine almost from scratch** 😬.
