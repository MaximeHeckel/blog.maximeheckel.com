...
<div style={{margin: "50px auto 0px auto", maxWidth: "250px"}}>

![Sunshine's App Icon](/static/images/sunshine-icon.svg)
...
!["Screenshot of Sunshine showcasing the main screen with the weather card. The weather card displays the weather at a given location, here Tokyo and Perth, with the temperature conditions and metrics such as wind speed or humidity, as well as a graph displaying the position of the sun.](/static/images/weather-card.svg)
...
![Screenshot of Sunshine's forecast panel. It showcases the 2 section: the first one displays the weather forecast at the given location for the next 6 hours, the second one for the next 7 days.](/static/images/forecast-panel.svg)
...
![Screenshot of Sunshine's settings panel. It showcases the 2 main section: the first one displays the list of locations the user has added the second one is the settings tab that lets the user choose between different units to display the temperature and the wind speed.](/static/images/settings-panel.svg)
