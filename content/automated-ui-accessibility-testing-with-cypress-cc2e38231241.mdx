...
![Cypress output with one accessibility issues](/static/images/1__wb7XX__RaUKDRawdVBCu9xQ.png)
...
![Accessibility violation failure summary for our first cypress test run](/static/images/1__FpWJmUGcyX1t3g__OUSr__yw.png)
...
![Successful cypress accessibility test run](/static/images/1__zS7P6cLOuHEeeBQpJyYXUA.png)
...
![Accessibility test run showcasing two moderate accessibility issues](/static/images/1__HQn____ccDyHh7dQU4f65BIg.png)
...
![Accessibility test run showcasing one contrast issues on the button with cyan background and white label](/static/images/1____56yiC68TRURMinyTsquuQ.png)
