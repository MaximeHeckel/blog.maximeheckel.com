...
import HSLAShowcase from '../src/components/Widgets/HSLAShowcase';
import PaletteGenerator from '../src/components/Widgets/PaletteGenerator';
import ThemePicker from '../src/components/Widgets/ThemePicker';
...
<blockquote class="twitter-tweet">
  <p lang="en" dir="ltr">
    Is this something you&#39;d do with your CSS variables? Or is this a direct
    &quot;no-no&quot;? 😅
    <br />
    <br />
    ...
    <br />
    <br />
    Would love to see what are your thoughts on this
    <a href="https://t.co/gHQLbwFDHf">pic.twitter.com/gHQLbwFDHf</a>
  </p>
  &mdash; Maxime 🇫🇷 (@MaximeHeckel) <a href="https://twitter.com/MaximeHeckel/status/1341062627221487616?ref_src=twsrc%5Etfw">December 21, 2020</a>
</blockquote> <script
  async
...
This technique allowed me to generate colors that _made sense_ and that I *understood* instead of picking up random colors that simply "looked nice".
