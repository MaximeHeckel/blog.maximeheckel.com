...
categories: []
keywords: []
slug: /@MaximeHeckel/automated-ui-accessibility-testing-with-cypress-cc2e38231241
---

![Photo by [Philipp Deus](https://unsplash.com/@philipp_deus?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)](img/1__giARXrzkOlrUWO7Kbh__Wag.jpeg)
Photo by [Philipp Deus](https://unsplash.com/@philipp_deus?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
...
_Note: The repository containing the code snippets featured in this article is available_ [_here_](https://github.com/MaximeHeckel/cypress-axe-example)_._
...
![package.json excerpt with our test script](img/1__le95a2bCe0AhSBC8TLDKwA.png)
...
![cypress/support/index.js excerpt with cypress-axe](img/1__kF__SCewfpEwLuzMYWVQwMg.png)
...
![Our first accessibility test using cypress-axe](img/1__dRaecCV5yfL0dKElZ0ZNUw.png)
...
![Gif showcasing the test script described in the first part](img/1____lNKDG4Df1xEBhWQDlTnBg.gif)
...
![Cypress output with one accessibility issues](img/1__wb7XX__RaUKDRawdVBCu9xQ.png)
...
![Accessibility violation failure summary for our first cypress test run](img/1__FpWJmUGcyX1t3g__OUSr__yw.png)
...
![Successful cypress accessibility test run](img/1__zS7P6cLOuHEeeBQpJyYXUA.png)
...
![The updated version of the options object passed to our accessibility test](img/1__C6V2FBSNrYEmiSrM7Xr3xg.png)
...
![Accessibility test run showcasing two moderate accessibility issues](img/1__HQn____ccDyHh7dQU4f65BIg.png)
...
![Accessibility test run showcasing one contrast issues on the button with cyan background and white label](img/1____56yiC68TRURMinyTsquuQ.png)
