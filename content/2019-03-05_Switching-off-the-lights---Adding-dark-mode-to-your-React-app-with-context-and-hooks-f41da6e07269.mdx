---
title: >-
  Switching off the lights - Adding dark mode to your React app with context and
  hooks
description: >-
...
keywords: []
slug: >-
  /@MaximeHeckel/switching-off-the-lights-adding-dark-mode-to-your-react-app-with-context-and-hooks-f41da6e07269
---

![Photo by [Alex Knight](https://unsplash.com/photos/5-GNa303REg?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/search/photos/japan?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)](img/1__opibt__PLUhicWYsyKhBtIQ.jpeg)
...
![The dark mode implementation on my website (sorry for the low frame rate 😅).](img/1__sPha27zqfIKg8TQu6cJg3g.gif)
