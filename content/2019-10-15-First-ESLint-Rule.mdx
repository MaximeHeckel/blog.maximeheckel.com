...
For this part, let's first go to AST explorer and write our expression to see how it translates into AST. By entering `CHECK && yup.validateSync()` we should get the following output:
