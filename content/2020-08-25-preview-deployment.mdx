...
categories: []
keywords: ['preview', 'preview deployment', 'branch preview', 'serverless', 'container', 'docker', 'frontent', 'react', 'CI/CD', 'review', 'velocity', 'development', 'collaboration']
...
import {
  DockerBuild,
  PreviewDeploy
} from '../src/components/MicroAnimations/PreviewDeploy';
