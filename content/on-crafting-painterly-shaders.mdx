...
date: '2026-10-29T08:00:00.000Z'
updated: '2024-09-16T08:00:00.000Z'
categories: []
...
- [Anisotropic Kuwahara Filtering with Polynomial Weighting Functions](https://www.umsl.edu/~kangh/Papers/kang-tpcg2010.pdf) by Jan Eric Kyprianidis, Amir Semmo, Henry Kang, and Jürgen Döllner who wrote a paper on using a polynomial weighting function instead of a Gaussian and also gave a lot of details necessary for my implementation of the anisotropic Kuwahara filter.
...
Luckily, [Anisotropic Kuwahara Filtering with polynomial Weighting Functions](https://www.umsl.edu/~kangh/Papers/kang-tpcg2010.pdf) answers this problem by building upon the concepts of the extended Kuwahara filter we just saw.
...
In [Anisotropic Kuwahara Filtering with polynomial Weighting Functions](https://www.umsl.edu/~kangh/Papers/kang-tpcg2010.pdf), the authors define the anisotropy `A` using those eigenvalues as follows:

<InlineMath>{String.raw`A = (\lambda_1 - \lambda_2) / (\lambda_1 + \lambda_2 + \text{1e-7})`}</InlineMath>
