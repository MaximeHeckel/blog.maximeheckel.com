...
keywords: []
slug: >-
  /@MaximeHeckel/https-medium-com-maximeheckel-how-to-efficiently-type-your-styled-components-with-flow-f43930a0dd2b
---
...
![The code of the Title styled-component](img/1__X2puVe2__sbvrCl__3__vgLQQ.png)
...
![Title component good and bad usage](img/1__gwnpwQwE04tCKaloATI8bQ.png)
...
![Abstract of the Theme used for this example](img/1__T5kY1BfhLc2jEOKHcPaXZw.png)
Abstract of the Theme used for this example
...
![First typed implementation of the Title component](img/1__Mj__0HUJ3pkKUbpMvklYefA.png)
...
![Example of valid but wrong usages of the typed Title component](img/1__vbogbPx7f2__VjDhoHIY0qg.png)
...
![Updated TitleProps type](img/1__ZnJ2bSnZAMi2Vtm4VpS9bg.png)
Updated TitleProps type

This would mean that Flow would fail if we use `Title` with `red1` as color:

![Flow error showing that using “red1" as color for the Title component is not valid](img/1__AQQKOj__R0oTr8nLF__wIwHQ.png)
...
![Final implementation of the Title component using the $Keys utility function](img/1__ZPbrMItWpjd6GoVppg39rQ.png)
