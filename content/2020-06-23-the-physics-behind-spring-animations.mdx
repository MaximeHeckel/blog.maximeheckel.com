...
categories: []
keywords: ['spring animation', 'framer motion', 'physics', 'ui', 'ux', 'design', 'transition', 'physics', 'harmonic oscillator']
...
const Chart = () => {
  ...
  const initialData = loop(stiffness, mass);
  const [data, setData] = React.useState(initialData);
  const [count, setCount] = React.useState(0);

  React.useEffect(() => {
    setData(loop(stiffness, mass));
    setCount(count + 1);
  }, [mass, stiffness]);
    ...
    >
      ...
      >
        <div style={{ display: 'grid' }}>
          <label for="mass1">Mass {mass}</label>
          <input
            id="mass1"
            type="range"
            min="1"
        ...
        <div style={{ display: 'grid' }}>
          <label for="stiffness1">Stiffness {stiffness}</label>
          <input
            id="stiffness1"
            type="range"
            min="1"
      ...
      >
        <motion.div
          ...
          transition={{ type: 'spring', stiffness, mass, damping: 0 }}
        />
      </div>
    </div>
  );
...
```js render
const { ResponsiveContainer, LineChart, Line, XAxis } = Recharts;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'grid' }}>
          <label for="stiffness">Stiffness {stiffness}</label>
          <input
            id="stiffness"
            type="range"
            min="1"
        ...
        <div style={{ display: 'grid' }}>
          <label for="damping">Damping {damping}</label>
          <input
            id="damping"
            type="range"
            min="0"
      ...
      >
        <motion.div
          ...
          transition={{ type: 'spring', stiffness, mass, damping }}
        />
      </div>
    </div>
  );
