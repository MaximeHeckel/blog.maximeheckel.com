...
description: How the new React Suspense API might reshape the way we build components
date: '2018-11-06T16:52:30.887Z'
categories: []
keywords: []
slug: /@MaximeHeckel/asynchronous-rendering-with-react-c323cda68f41
---
...
![Code Snippet 1: React component doing an asynchronous call before rendering the data implemented using a Class.](img/1__8__ggbIJQyr5IPU6J1cEY1g.png)
...
![Code Snippet 2: React component doing an asynchronous call before rendering the data implemented using React Suspense.](img/1__t4__eKz8cpZNsJNjCyl78hw.png)
...
![Code Snippet 3: Fetcher resource implementation using functions from react-cache](img/1__821iKOC9HBIQ0et__msvVag.png)
...
![Code Snippet 4: The full example of a functional React component using the Suspense API](img/1__3iP1UYj5__2pf__o9ZjqvUqQ.png)
...
_Making flexible, easily testable and reusable views in React without ending in “markup hell”_medium.com](https://medium.com/maxime-heckel/react-sub-components-513f6679abed "https://medium.com/maxime-heckel/react-sub-components-513f6679abed")[](https://medium.com/maxime-heckel/react-sub-components-513f6679abed)
...
_Adding Flow on top of styled components to avoid misusages before they hit production, and make developers’ and…_medium.com](https://medium.com/maxime-heckel/https-medium-com-maximeheckel-how-to-efficiently-type-your-styled-components-with-flow-f43930a0dd2b "https://medium.com/maxime-heckel/https-medium-com-maximeheckel-how-to-efficiently-type-your-styled-components-with-flow-f43930a0dd2b")[](https://medium.com/maxime-heckel/https-medium-com-maximeheckel-how-to-efficiently-type-your-styled-components-with-flow-f43930a0dd2b)
