...
description: How to use the Jest platform to run Golang test
date: '2018-01-10T17:00:17.216Z'
categories: []
keywords: []
slug: /@MaximeHeckel/running-golang-tests-with-jest-b5d8f3d43a7
---
...
![Diagram representing the lifecycle of a test run with Jest including multiple Jest runners.](img/1__tnK7Hzbq7cXG6r7TtIDIKA.jpeg)
Diagram representing the lifecycle of a test run with Jest including multiple Jest runners.
...
[**Jest-runner-go**  
_Recorded by maxime_asciinema.org](https://asciinema.org/a/9grFmeodfWDGbT88XLGJk5Gak "https://asciinema.org/a/9grFmeodfWDGbT88XLGJk5Gak")[](https://asciinema.org/a/9grFmeodfWDGbT88XLGJk5Gak)
...
[**Gojest running Docker tests**  
_Recorded by MaximeHeckel_asciinema.org](https://asciinema.org/a/OQ8MQDGYNiQ2aqUECvGk061ZD "https://asciinema.org/a/OQ8MQDGYNiQ2aqUECvGk061ZD")[](https://asciinema.org/a/OQ8MQDGYNiQ2aqUECvGk061ZD)
