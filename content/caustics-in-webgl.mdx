...
Since my work with [refraction and chromatic dispersion](/post/refraction-dispersion-and-other-shader-light-effects/) from early 2023, I have not ceased to experiment with light effects and shaders, always trying to strike the right balance between realism, aesthetics, and performance.
...
<Image
  src="blog/converging_diverging_rays.png"
...
<Fullbleed widthPercent={80}>
  <Image
    src="blog/normal_projection_fbo.png"
...
<Fullbleed widthPercent={70}>
  <Image
    src="blog/caustics_normal_fbo.png"
...
<Image
  src="blog/projection_fragment.png"
...
<Image
  src="blog/caustics_clamp_value_issue.png"
...
<BeforeAfterImage
  ...
  beforeSrc="blog/caustics_chromatic_before.png"
  afterSrc="blog/caustics_chromatic_after.png"
...
### Scaling and positioning our Caustics
...
<Image
  src="blog/center_caustics_plane.png"
...
<Image
  src="blog/scale_caustic_plane.png"
...
<Image
  src="blog/caustics_simple_mesh.png"
