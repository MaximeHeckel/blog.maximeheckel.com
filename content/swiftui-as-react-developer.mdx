...
![Diagram showcasing the main elements composing a SwiftUI view: View, Property Wrapper and modifier](/static/images/diagramswiftuiview.svg)
...
<figure>
    <img style={{marginBottom: "0px"}} src="/static/images/diagramswiftuistatemanagement.svg" alt="Diagram showcasing how a view re renders in SwiftUI following a state change"/>
