...
<figure>
  <img
    ...
    src="/static/images/diagramswiftuistatemanagement.svg"
    alt="Diagram showcasing how a view re renders in SwiftUI following a state change"
  />
  <figcaption>
    Diagram showcasing how a view "re-renders" in SwiftUI following a state
    change. This cycle is very similar to the one we're familiar with React.
  </figcaption>
</figure>
