...
![Flow error output with the first iteration of the “Props” Flow type for ResourceList](/static/images/1__K4q47RYFJGlAz0nkpY32hw.png)
...
![Flow output with no errors thanks to the new ResourceList “Props” Flow type!](/static/images/1__tQs3TltRtn__sntDOaUxdLg.png)
