...
We’ll see how to implement an **atmospheric scattering post-processing effect step-by-step**, starting with the implementation of the different building blocks to render **a realistic sky dome**, and then adapt the result to render it as **an atmospheric shell around a planet**. 
