...
![Illustration of each step of a CI/CD pipeline and which of the team, the organization and the end-user they impact the most](/static/images/CICD.svg)
...
![Illustration showcasing the difference in testing paths possible between e2e (only the "happy path") and integration tests (all paths)](/static/images/HappyPathVSAllPaths.svg)
<br/>
<br/>
