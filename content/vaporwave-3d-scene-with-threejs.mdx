...
updated: '2022-01-25T08:00:00.000Z'
categories: []
keywords: []
...
1. Draw the grid and export it as a `.jpg` or `.png` on a software like Figma for example
...
You can download the texture I made on my own [here](https://res.cloudinary.com/dg5nsedzw/image/upload/v1641657168/blog/vaporwave-threejs-textures/grid.png). It's pretty heavy, but I'll talk about that a bit later.

</Callout>

After loading the texture, we then apply it on the plane by assigning the texture to the `normalMap` property of the material, and we get something like this:
...
If you want to hack on top of it and have some fun, or simply use it as a base for your next Three.js creation you can head over to the <Anchor favicon href="https://github.com/MaximeHeckel/linear-vaporwave-three.js">Github repository of this project</Anchor> 😄. I'll try to provide a React Three Fiber equivalent in the upcoming weeks (I promise!).
