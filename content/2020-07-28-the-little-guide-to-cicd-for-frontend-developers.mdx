...
featured: false
colorFeatured: 'linear-gradient(252.99deg,#d5e2fd -2.88%,#cdd9ff 127.16%)'
fontFeatured: '#000000'
---
...
<figcaption>A CI/CD pipeline and which of the team, the organization and the end-user is most impacted at different steps</figcaption>
