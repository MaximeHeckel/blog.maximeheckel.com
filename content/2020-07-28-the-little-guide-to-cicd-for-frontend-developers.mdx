...
import {
  ...
  IntegrationTest,
  UnitTest
} from '../src/components/MicroAnimations/CICD';
...
![Illustration of each step of a CI/CD pipeline and which of the team, the organization and the end-user they impact the most](img/CICD.svg)
<figcaption>Illustration of each step of a CI/CD pipeline and which of the team, the organization and the end-user they impact the most</figcaption>
...
-   you do not want to bring confusion on how to write a given piece of code in your app when you onboard a new team members
...
![Illustration showcasing the difference in testing paths possible between e2e (only the "happy path") and integration tests (all paths)](img/HappyPathVSAllPaths.svg)
<figcaption>Illustration showcasing the difference in testing paths possible between e2e (only the "happy path") and integration tests (all paths)</figcaption>
<br/>
<br/>
