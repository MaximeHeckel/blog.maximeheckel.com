...
categories: []
keywords: []
slug: /@MaximeHeckel/how-i-got-started-with-kubernetes-on-gke-5f829eca98bc
---
...
![Kubernetes contexts list menu in Docker for Mac](img/1__QGmeP4rJQSm1YF38684yWw.png)
...
![List of Kubernetes services](img/1__0hgHhzjFzrrN__mOY1jqopQ.png)
...
![List of Kubernetes ingresses](img/1__Z6__gkS9RooYBK96__s5u0__A.png)
...
*   Edit `kube-cert-manager-deployment.yml` and fill the different fields such as your email and the DNS provider. The documentations about DNS provider is available [here](https://github.com/PalmStoneGames/kube-cert-manager/blob/master/docs/providers.md). In my case, my domain was managed by Dnsimple so I had to edit the deployment file like this:
      ...
      containers:  
        - name: kube-cert-manager  
          env:  
          - name: DNSIMPLE\_BASE\_URL  
            value: [https://api.dnsimple.com](https://api.dnsimple.com)  
          - name: DNSIMPLE\_OAUTH\_TOKEN  
...
![Logs from the cert-manager Pod](img/1__F3186t6LGQIg5ujjh75a0g.png)
...
#### If you liked this article don’t forget to hit the “clap” button and if you have any other questions I’m always reachable on [Twitter](http://twitter.com/MaximeHeckel), or on my [website](https://maximeheckel.com) (which is one of the services I’ve migrated to GKE 🙂). You can also subscribe to my [Medium publication](https://medium.com/maxime-heckel) to not miss my next post.
