...
categories: []
keywords: ['health', 'shortcut', 'apple', 'serverless', 'fauna', 'faunadb', 'graphql', 'data', 'heart rate', 'api', 'query', 'mutation', 'vercel']
slug: build-personal-health-api-shortcuts-serverless
type: 'blogPost'
colorFeatured: ' linear-gradient(269.49deg, #859EF5 -19.17%, #FFE9F2 101.46%)'
fontFeatured: '#000000'
featured: true
---

import HeartRateWidget from '../src/components/HeartRateWidget';
...
![Diagram showcasing the different elements of this project described below](./img/shortcut-health-plan.png)
...
2. The serverless function, hosted on [Vercel](https://vercel.com/), will receive that data, sanitize it, and then send a GrahQL mutation to [FaunaDB](https://fauna.com/) (I'll get into why I chose FaunaDB later in the article)
...
![Screenshots of the Shortcuts app editor showcasing the different steps executed when running the shortcut described below](./img/shortcut.png)
...
![Screenshot of the heart rate and steps dictionaries used in the body of the HTTP POST request of our shortcut](./img/dictionaries.png)
...
4. Add the following script in your `package.json`: `  "start": "vercel dev"`.
...
![Screenshot of FaunaDB GraphQL playground with a query to get all our entries](./img/fauna-graphql-query.png)
...
![Screenshot of the Entry collection on my Fauna dashboard, populated with documents containing some of the health samples I sent with my shortcut](./img/fauna-entry-collection.png)
