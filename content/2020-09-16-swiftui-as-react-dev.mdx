...
categories: []
keywords: ['swiftui', 'swift', 'react', 'reactive', 'iOS', 'frontend', 'developer', 'native', 'web']
...
<figure>
    <img style="margin-bottom:0px;" src="./img/diagramswiftuiview.svg" alt="Diagram showcasing the main elements composing a SwiftUI view: View, Property Wrapper and modifier"/>
    <figcaption>Diagram showcasing the main elements composing a SwiftUI view</figcaption>
</figure>
...
<figure>
    <img style="margin-bottom:0px;" src="./img/diagramswiftuistatemanagement.svg" alt="Diagram showcasing how a view re renders in SwiftUI following a state change"/>
    <figcaption>Diagram showcasing how a view "re-renders" in SwiftUI following a state change. This cycle is very similar to the one we're familiar with React.</figcaption>
</figure>
...
```js title=Basic state management in SwiftUI unsing the @State property wrapper
