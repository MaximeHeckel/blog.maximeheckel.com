...
![Screenshot showcasing the Cypress GUI with the browser selection dropdown expanded.](/static/images/cypress-cross-browser.png)
...
![Screenshot showcasing a successful Github CI run including our scheduled cross-browser tests on Chrome and Firefox](/static/images/cypress-cross-browser-run.png)
