...
![Schema representing a styled component "StyledButton" from myLib rendered within the Emotion Theme Provider of myApp](/static/images/setup-schema-npm-dep.png)
