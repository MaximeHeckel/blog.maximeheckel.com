...
description: Dealing with dependencies when developing a package and using it through npm link.
date: '2020-03-31T08:00:00.000Z'
categories: []
keywords:
  ['npm', 'link', 'peerDependencies', 'dependencies', 'package', 'context', 'react', 'webpack', 'invalid hook call', 'provider']
...
![Schema representing a styled component "StyledButton" from myLib rendered within the Emotion Theme Provider of myApp](img/setup-schema-npm-dep.png)
