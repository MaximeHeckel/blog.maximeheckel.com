...
![Diagram showcasing the different elements of this project described below](/static/images/shortcut-health-plan.png)
...
![Screenshots of the Shortcuts app editor showcasing the different steps executed when running the shortcut described below](/static/images/shortcut.png)
...
![Screenshot of the heart rate and steps dictionaries used in the body of the HTTP POST request of our shortcut](/static/images/dictionaries.png)
...
![Screenshot of FaunaDB GraphQL playground with a query to get all our entries](/static/images/fauna-graphql-query.png)
...
![Screenshot of the Entry collection on my Fauna dashboard, populated with documents containing some of the health samples I sent with my shortcut](/static/images/fauna-entry-collection.png)
