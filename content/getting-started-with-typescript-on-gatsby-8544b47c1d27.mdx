...
![Here we can see VSCode highlighting the tslint issues as well as the gatsby cli showing the warnings in the terminal](/static/images/1__tIDz__0NDFheenbNkbMG35w.png)
...
![This screenshot shows VSCode highlighting the missing type declaration of a module](/static/images/1__w8E5swN7JC2E7__ww2xSPhg.png)
