...
- Writing my own Semantic Release plugin <Pill color="#34C559" text="Done"/>
- Setting up a High-Velocity Development environment for my team <Pill color="#34C559" text="Done"/>
- Building my own preview deployment service <Pill color="#34C559" text="Done"/>

I'm writing a pretty big blog post about CI/CD for frontend developers! It will contain most of the items listed above.
Also, I recently built my own preview deployment service. It will be mentioned in that CI/CD article but it deserves an entire post on its own.
...
**SwiftUI**
- Getting started with SwiftUI development <Pill color="#34C559" text="Done"/>
- Learn how to build beautiful apps (animation, custom SwiftUI views and components) <Pill color="#FF9502" text="In Progress"/>
...
- Comparing SwitftUI to React development <Pill color="#FF9502" text="In Progress"/>

From what I'm seeing so far React and SwiftUI have quite a few things in common. Expect some upcoming blog posts about State management in SwiftUI and React Components vs SwiftUI Views. I hope these post will help some React developers to feel more comfortable with SwiftUI.
...
- Building my own iOS app from scratch
