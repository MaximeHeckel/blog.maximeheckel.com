...
- Use the serverless framework <Pill color="#FF9502" text="In Progress"/>
- Deploy some cloud functions with an API gateway <Pill color="#FF9502" text="In Progress"/> 
...
I've always loved beautiful transitions/animations and wanted to get into using the toold that Framer built for a while
...
- Avoid dropping frames with Framer Motion
