...
- What I learned building my own Gatsby Theme 
- Everything I've learned (the hard way) when dealing with SEO and Gatsby <Pill color="#FF9502" text="In Progress"/>
...
- Building my own iOS app from scratch <Pill color="#FF9502" text="In Progress"/>
