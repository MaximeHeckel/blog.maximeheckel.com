...
- Use the serverless framework <Pill color="#FF9502" text="Done"/>
- Deploy some cloud functions with an API gateway <Pill color="#FF9502" text="Done"/> 
...
It took me a while to find a use case for a serverless function, but I ended up finding one: **Generating screenshot from code snippets**. I wrote about it here in [this post](/posts/creating-beautiful-screenshots-source-code-with-serverless-function?featured=true).
...
- Demistify spring animations <Pill color="#FF9502" text="In Progress"/>
