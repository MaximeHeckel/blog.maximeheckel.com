...
description: Here's an up to date list of what I'm currently learning and what I plan to learn.
...
I've felt very inspired by [@swyx](https://twitter.com/swyx)'s concept of learning in public. His blog post "Learn In Public: The fastest way to learn" deep dives into the idea of sharing as much as possible what we're working on, what we learn, to become more than just lurker or content consumer and "to have a habit of creating learning exhaust".
...
*Note: Some items are still in progress, I'll make sure to add the resources I've used in the meantime until I decide whether a subject is worth writing or not.*
