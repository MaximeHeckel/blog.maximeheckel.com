...
const FinalFragmentShader = `uniform sampler2D inputBuffer;
uniform vec4 resolution;
...
import finalFragmentShader from "!!raw-loader!./finalFragmentShader.glsl";
...
const Painting = () => {
  ...
  const texture = useTexture("https://cdn.maximeheckel.com/textures/paper/watercolor.png");
  ...
  return (
    <Canvas dpr={[1, 2]}>
      <Suspense fallback="Loading">
        ...
        <color attach="background" args={["#5386E0"]} />
        <Painting />
        <OrbitControls />
        <OrthographicCamera
          makeDefault
...
const Final = {
  ...
  '/finalFragmentShader.glsl': {
    code: FinalFragmentShader,
    active: true,
  },
};
