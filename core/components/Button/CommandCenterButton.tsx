  ...
  return (
    ...
    >
      ...
      >
        ...
        <VisuallyHidden as="p" id="commandCenterDesc">
          Opens a modal to allow you to quickly search for the content of this
      ...
      <motion.span
        ...
        css={css`
          color: hsla(var(--palette-gray-80));
          background: hsla(var(--palette-gray-00));
